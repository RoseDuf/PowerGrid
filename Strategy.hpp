...
class Strategy {
    ...
    public:
        ...
        virtual BiddingChoice getBiddingChoice(Player* player, Elektro highestBigSoFar) = 0;
        virtual BiddingChoice getBiddingChoice(Player* player, int highestBigSoFar) = 0;
